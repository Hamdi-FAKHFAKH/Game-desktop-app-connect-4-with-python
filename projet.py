...
windows.title("Jeux puissance 4 ")
...
def puissance4():
    ...
    titre1 = Label(windows, text="Puissance 4 \n C'est Ton Tour " + joueur1, font=("courrier", 30), bg='#4065A4',fg='white', bd=5)
    ...
    def Fctbouton(id):
        ...
        titre1.destroy()
        if (ActivePlayer==1):
            titre1 = Label(windows, text="Puissance 4 \n C'est Ton Tour " + joueur2, font=("courrier", 30), bg='#4065A4', fg='white', bd=5)
            titre1.grid(row=0, column=0, padx=0, pady=12, ipadx=0, ipady=0)
